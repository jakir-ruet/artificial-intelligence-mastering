...
- `multiple-files.py:` Main script for multi-source data ingestion
- `energy-efficiency.csv:` Building energy efficiency dataset
- `building-meta.json:` Building metadata in JSON format
- `combined-dataset.csv:` Final merged dataset from all sources
